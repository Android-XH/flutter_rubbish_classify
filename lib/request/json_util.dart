...
//      encoderString.split('\n').forEach((element) => print(element));
  ...
  static void printRespond(Response response) {
    Map httpLogMap = Map();
    httpLogMap.putIfAbsent("requestUrl", () => response.request.uri.toString());
    ...
    httpLogMap.putIfAbsent("requestBody", () => response.request.data);
    httpLogMap.putIfAbsent("versionData", () => response.headers.value("versionData"));
